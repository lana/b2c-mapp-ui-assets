<template>
  ...
  >
    <defs>
      <clipPath id="clip-path" transform="translate(-1.6 0)">
    ...
    <g clip-path="url(#clip-path)">
      <g>
        <path d="M35.907,3.12A40.264,40.264,0,0,0,20,0,40.273,40.273,0,0,0,4.088,3.12,4.123,4.123,0,0,0,1.6,6.887V19.059A21.409,21.409,0,0,0,15.786,38.9l1.788.667a7.025,7.025,0,0,0,4.851,0l1.784-.667A21.4,21.4,0,0,0,38.4,19.059V6.887a4.12,4.12,0,0,0-2.49-3.767Z" transform="translate(-1.6 0)" fill="url(#Degradado_sin_nombre)"/>
        ...
        />
        <g mask="url(#mask-2)">
          <path d="M27.125,28V16.6L12.875,28Z" transform="translate(-1.6 0)" opacity="0.5" fill="url(#Degradado_sin_nombre_2)" style="isolation: isolate"/>
        </g>
